class SeachSheinModel {
  ...
  factory SeachSheinModel.fromJson(Map<String, dynamic> json) {
    return SeachSheinModel(
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    return Product(
      ...
      unit: json["unit"],
      tag3PLabelName: json["tag_3p_label_name"],
    );
  }
}
