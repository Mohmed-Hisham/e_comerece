            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text(StringsKeys.historyChats.tr, style: styleAll),
                  trailing: FaIcon(
                ...
                ListTile(
                  ...
                  trailing: Icon(Icons.language, color: Appcolor.primrycolor),
                ),
                ListTile(
                  onTap: () {
                  ...
                  trailing: Icon(Icons.logout, color: Appcolor.primrycolor),
                ),
              ],
            ),
          ),
