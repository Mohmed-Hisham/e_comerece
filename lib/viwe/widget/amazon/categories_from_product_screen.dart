...
class CategoriesFromProductScreen extends StatelessWidget {
  const CategoriesFromProductScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final ScrollController scrollController = ScrollController();

    return GetBuilder<ProductFromCategoriesControllerImpl>(
      builder: (controller) {
        ...
        return SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final String currentName = current.name ?? StringsKeys.unknown.tr;
